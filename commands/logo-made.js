...
const maker = require('@sl-code-lords/text-pro-me')

    //---------------------------------------------------------------------------
cmd({ pattern: "cartoon", category: "textpro", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
        if (!text) return citel.reply('_Need text._')
        let anu = await maker.textpro('https://textpro.me/3d-cartoon-text-effect-generator-online-1123.html', text)
